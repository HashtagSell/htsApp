...
if(process.env.NODE_ENV === "DEVELOPMENT") { //Run the local prerender server
    ...
    var postingAPI = '//ec2-52-11-249-169.us-west-2.compute.amazonaws.com:8882',
        notificationAPI = '//ec2-52-11-249-169.us-west-2.compute.amazonaws.com:8884',
        realtimeAPI = '//ec2-52-11-249-169.us-west-2.compute.amazonaws.com:8881';
