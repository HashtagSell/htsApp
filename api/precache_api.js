...
exports.recache = function (req, res) {
    ...
    request.post(env.prerender_io.url + '/recache', {prerenderToken: env.prerender_io.token, url: env.hts.appURL + 'fb' + postingId}, function callback(err, httpResponse, body) {
        if (err) {
