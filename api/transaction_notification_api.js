        ...
        async.waterfall([
            ...
            function (buyerUserObj, sellerUserObj, done) {
                ...
                var emailObj = {
                    ...
                    buttons: {
                        payment: {
                            url : env.hts.appURL + '/payment/' + offerObj.posting.postingId + '/' + offerObj.id
                        },
                        review: {
                            url: env.hts.appURL + '/review?postingId=' + offerObj.posting.postingId + '&offerId=' + offerObj.id
                        }
                    }
                };
            ...
            function (buyerUserObj, sellerUserObj, compiled_html_seller, plain_text_seller, compiled_html_buyer, plain_text_buyer, done) {
                ...
                var sellerInstantReminder = {
                    from: "HashtagSell Offer <no-reply@hashtagsell.com>",
